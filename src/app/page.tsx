...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-24 pb-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            {/* Updated Stats with better labels and larger font sizes */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">28M+</div>
                <div className="text-gray-600 font-medium">Bags mishandled annually</div>
                <div className="text-sm text-gray-500 mt-1">Don't be a statistic</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">$250M+</div>
                <div className="text-gray-600 font-medium">Money saved for travelers</div>
                <div className="text-sm text-gray-500 mt-1">Through smart tracking</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">99.9%</div>
                <div className="text-gray-600 font-medium">Recovery rate of tracked items</div>
                <div className="text-sm text-gray-500 mt-1">Industry-leading accuracy</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Features Section - Fixed icon sizes and alignment */}
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Everything You Need to Track Anything</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="p-6 border border-gray-200 rounded-xl hover:shadow-lg transition-shadow h-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow h-full">
      ...
      {/* Testimonials Section - Fixed alignment and uniform styling */}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="p-6 border border-gray-200 rounded-xl hover:shadow-lg transition-shadow h-full">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed text-base">"{testimonial.content}"</p>
      ...
      {/* Pricing Section - Fixed consistent styling and alignment */}
      <section id="pricing" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-blue-500 relative h-full flex flex-col">
      ...
      {/* Footer - Fixed spacing and structure */}
